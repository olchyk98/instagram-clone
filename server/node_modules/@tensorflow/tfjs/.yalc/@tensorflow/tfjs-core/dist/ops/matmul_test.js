...
jasmine_util_1.describeWithFlags('packed matmul', test_util_1.WEBGL_ENVS, function () {
    ...
    it('works when followed by a reshape that changes texture layout, and then an unpacked op', function () {
