...
jasmine_util_1.describeWithFlags('packed batchNormalization', test_util_1.WEBGL_ENVS, function () {
    var webglPackedBatchNormalizationSavedFlag = tf.ENV.get('WEBGL_PACK_BATCHNORMALIZATION');
    beforeAll(function () {
        tf.ENV.set('WEBGL_PACK_BATCHNORMALIZATION', true);
    });
    afterAll(function () {
        tf.ENV.set('WEBGL_PACK_BATCHNORMALIZATION', webglPackedBatchNormalizationSavedFlag);
    });
    it('should not leak memory', function () {
        ...
        tf.batchNormalization4d(x, mean, variance, varianceEpsilon, undefined, undefined);
...
jasmine_util_1.describeWithFlags('batchNormalization2D', test_util_1.ALL_ENVS, function () {
    ...
    it('throws error when x is a string tensor', function () {
        ...
        var scale = [4, 5];
        var varianceEpsilon = .001;
        var f = function () { return tf.batchNormalization2d([['a', 'b'], ['c', 'd']], mean, variance, varianceEpsilon, scale, offset); };
        expect(f).toThrowError(/Argument \'x\' passed to \'batchNormalization\' must be numeric/);
    });
    it('throws error when mean is a string tensor', function () {
        ...
        var scale = [4, 5];
        var varianceEpsilon = .001;
        var f = function () { return tf.batchNormalization2d(x, ['a', 'b'], variance, varianceEpsilon, scale, offset); };
        expect(f).toThrowError(/Argument \'mean\' passed to \'batchNormalization\' must be numeric/);
    });
    it('throws error when variance is a string tensor', function () {
        ...
        var scale = [4, 5];
        var varianceEpsilon = .001;
        var f = function () { return tf.batchNormalization2d(x, mean, ['a', 'b'], varianceEpsilon, scale, offset); };
        expect(f).toThrowError(/\'variance\' passed to \'batchNormalization\' must be numeric/);
    });
    it('throws error when scale is a string tensor', function () {
        ...
        var offset = [3, 4];
        var varianceEpsilon = .001;
        var f = function () { return tf.batchNormalization2d(x, mean, variance, varianceEpsilon, ['a', 'b'], offset); };
        expect(f).toThrowError(/\'scale\' passed to \'batchNormalization\' must be numeric/);
    });
    it('throws error when offset is a string tensor', function () {
        ...
        var scale = [4, 5];
        var varianceEpsilon = .001;
        var f = function () { return tf.batchNormalization2d(x, mean, variance, varianceEpsilon, scale, ['a', 'b']); };
        expect(f).toThrowError(/\'offset\' passed to \'batchNormalization\' must be numeric/);
    });
});
