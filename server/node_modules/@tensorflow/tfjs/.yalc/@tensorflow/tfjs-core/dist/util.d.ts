...
export declare function flatten<T extends number | boolean | string | Promise<number>>(arr: T | RecursiveArray<T>, ret?: T[]): T[];
...
export declare function isTypedArray(a: TensorLike): boolean;
